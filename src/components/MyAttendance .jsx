            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                        Track your check-ins and monthly attendance record.
                    </p>
                </div>
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-4">
                            <p className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Present</p>
                            <p className="text-xl font-semibold text-green-600 dark:text-green-400 mt-1">{summary?.presentDays ?? 0}</p>
                        </div>
                        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-4">
                            <p className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Absent</p>
                            <p className="text-xl font-semibold text-red-500 dark:text-red-400 mt-1">{summary?.absentDays ?? 0}</p>
                        </div>
                        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-4">
                            <p className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Half Days</p>
                            <p className="text-xl font-semibold text-amber-600 dark:text-amber-400 mt-1">{summary?.halfDays ?? 0}</p>
                        </div>
                        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-4">
                            <p className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Total Hours</p>
                            <p className="text-xl font-semibold text-indigo-600 dark:text-indigo-400 mt-1">{summary?.totalWorkingHours ?? 0}h</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
                        {records.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <p className="text-sm text-slate-400 dark:text-slate-500">No attendance records for this month</p>
                            </div>
                        ) : (
                                ...
                                <table className="w-full text-sm">
                                    <thead>
                                        <tr className="border-b border-slate-100 dark:border-slate-800 text-left">
                                            ...
                                            <th className="px-5 py-3 font-medium text-slate-500 dark:text-slate-400">Check In</th>
                                            <th className="px-5 py-3 font-medium text-slate-500 dark:text-slate-400">Check Out</th>
                                            <th className="px-5 py-3 font-medium text-slate-500 dark:text-slate-400">Hours</th>
